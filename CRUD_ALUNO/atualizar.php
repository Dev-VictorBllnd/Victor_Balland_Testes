...
<body>
    <div class="container painel-principal">
        ...
        <h1 class="text-center mb-4">Alteração de Dados do Aluno</h1>

        <hr class="linha-divisoria">
    <h1 align="center">Procurar Aluno</h1>

    <form method="POST" action="formAtualizar.php" class="row justify-content-center mb-4">
        <div class="col-md-6">
            <label for="iID" class="form-label">Nome do Aluno(a):</label>
            <input id="iID" type="text" class="form-control" name="ID">
        </div>
